...
extension Tagged::Tagged where Underlying: BinaryFloatingPoint {
    ...
    internal static func _quantize<S>(_ value: Underlying, in space: S.Type) -> Self {
        ...
        guard let quantized = S.self as? any Numeric::Numeric.Quantized.Type else {
    ...
    @usableFromInline
    internal static func _quantize<Q: Numeric::Numeric.Quantized>(
        _ value: Underlying,
...
extension Tagged::Tagged where Tag: Spatial, Tag.Space: Numeric::Numeric.Quantized, Underlying: BinaryFloatingPoint {
